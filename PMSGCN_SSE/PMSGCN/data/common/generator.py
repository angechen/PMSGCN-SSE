...
class ChunkedGenerator:
    ...
    shuffle -- randomly shuffle the dataset before each epoch,随机排序
    ...
    def __init__(self, batch_size, cameras, poses_3d, poses_2d,
                 ...
                 augment=False, reverse_aug= False,kps_left=None, kps_right=None, joints_left=None, joints_right=None, #augment=true
